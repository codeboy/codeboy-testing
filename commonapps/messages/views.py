...
from commonapps.messages.models import Message
from commonapps.messages.forms import ComposeForm
from commonapps.messages.utils import format_quote
...
def compose(request, recipient=None, form_class=ComposeForm,
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            for u in form.cleaned_data['recipient']:
                user = User.objects.get(username=u)
                send_mail([user.email,], u'Вам отправили сообщение', u'Сообщение')
...
#        print u'target = %s | come = %s' % (message.recipient, user)
#        raise Http404
        pass
